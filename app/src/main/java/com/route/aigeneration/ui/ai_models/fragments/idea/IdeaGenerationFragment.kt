package com.route.aigeneration.ui.ai_models.fragments.idea
...
class IdeaGenerationFragment : BaseFragment<FragmentIdeaGenerationBinding>() {
    private val adapter = MessagesAdapter(arrayListOf())
    private val messages = arrayListOf<Messages>()

    override fun getLayoutID(): Int = R.layout.fragment_idea_generation
